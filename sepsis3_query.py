def suspicion_infection(hosp_name: str, derived_name:str)->str:
    """
    """
    query = f"""
        ...
        WITH ab_tbl AS (
            ...
            FROM `{derived_name}.antibiotic` abx
        )
        ...
        , me AS (
            ...
            FROM `{hosp_name}.microbiologyevents`
...
def SOFA(derived_name:str)->str:
    """_summary_

    Args:
        derived_name (str): _description_
